...
export const ICONS = {
  ...
  /** Picture-in-picture frame outline + smaller inset frame at the
   *  top-right corner. Outlined when PiP is off. */
  pipOutline: wrap(
    `<g transform="translate(1.5 2)" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><rect x="0.5" y="0.5" width="12" height="9" rx="1.2"/><rect x="6.8" y="3" width="5" height="4" rx="0.6" stroke-width="1.1"/></g>`,
  ),
  /** Filled inset frame — PiP is on. */
  pipFilled: wrap(
    `<g transform="translate(1.5 2)" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><rect x="0.5" y="0.5" width="12" height="9" rx="1.2"/><rect x="6.8" y="3" width="5" height="4" rx="0.6" fill="currentColor" stroke="none"/></g>`,
  ),
